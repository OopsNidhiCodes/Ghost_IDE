...
describe('GhostChat', () => {
  ...
  it('sends message when user types and presses Enter', async () => {
    ...
    expect(mockWebsocketService.sendGhostMessage).toHaveBeenCalledWith(
  ...
  it('sends message when user clicks send button', async () => {
    ...
    expect(mockWebsocketService.sendGhostMessage).toHaveBeenCalled();
  });
  ...
  it('does not send empty messages', async () => {
    ...
    expect(mockWebsocketService.sendGhostMessage).not.toHaveBeenCalled();
  });
